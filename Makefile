...
bin/example:
	g++ --std=c++11 -g -O2 -Wall -I/usr/local/include -Xlinker -rpath -Xlinker /usr/local/lib  src/example.cpp  -L/usr/local/lib -liRRAM -lmpfr -lm -lgmp -lpthread -o bin/example
